...
data_manager = DataManager(       # initialize data manager
    ...
    fs_root_folder="InformatikApp"  # folder on switch drive where the data is stored
    ) 
...
pg_second = st.Page("views/BMI_Rechner.py", title="BMI Rechner", icon=":material/info:")
